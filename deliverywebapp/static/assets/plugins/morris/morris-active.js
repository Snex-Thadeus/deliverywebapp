$(document).ready(function () {
	...
	Morris.Bar({
		...
		gridEnabled: true,
		gridLineColor: '#ddd',
		gridTextColor: '#868DAA',
		gridTextSize: '11px',
		gridTextFamily: '"Montserrat", sans-serif',
		barColors: ['#6777ef'],
		resize: true,
		hideHover: 'auto',
	});
	...
	Morris.Donut({
		...
		colors: ['#63CF72', '#5D78FF', '#C9D5FA', '#FABA66', '#EE8CE5', '#5D78FF'],
		resize: true
	});
});